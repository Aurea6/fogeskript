...
exports.default = new structures_1.NativeFunction({
    ...
    async execute(ctx, [text]) {
        ...
        if (data2 === undefined || data2 === 0) {
          ...
          const response = await fetch('https://api.kastg.xyz/api/ai/chatgptV4?prompt=- Your role: You%27re an AI who is extremely good at coding, you will help users to understand their code, create code for them and how to use them specifically you are chadded in coding stuff - User Message:' + text);
